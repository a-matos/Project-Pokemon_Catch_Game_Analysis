...
//***// Buttons to ADD & Remove pokemons //***//
...
async function insertPokemon() {
  try {
    ...
    const allItems = [];
    const result = []; //*create an array for results

    for (let pokemonInfo in pokemonDataJSON) { //*To convert  JSON in array
